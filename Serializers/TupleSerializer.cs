...
namespace ProtoBuf.Serializers
{
    sealed class TupleSerializer : IProtoTypeSerializer
    {
        ...
        private object GetValue(object obj, int index)
        {
            ...
            {
                if (obj == null)
                    return Helpers.IsValueType(prop.PropertyType) ? ProtoActivator.CreateInstance(prop.PropertyType) : null;
                return prop.GetValue(obj, null);
            }
            else if ((field = members[index] as FieldInfo) != null)
            {
                if (obj == null)
                    return Helpers.IsValueType(field.FieldType) ? ProtoActivator.CreateInstance(field.FieldType) : null;
